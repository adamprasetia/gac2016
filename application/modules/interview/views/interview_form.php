		...
		<div class="col-md-8 col-sm-8">
			...
			<div class="box box-smoker hide">
				<div class="box-body">
					...
					<h3><b>Selamat Mas/Mbak terpilih sebagai kandidat pemenang dari program GO AHEAD CHALLENGE 2016</b></h3>
			...
			<div class="box box-verification hide">
				<div class="box-body">
					...
					<h4>Sebelumnya kami beritahukan bahwa seluruh pembicaraan yang terjadi di telepon ini akan direkam untuk selanjutnya kami jadikan bahan pertimbangan dalam proses pemilihan pemenang.</h4>
					<h4>Perlu kami informasikan bawah pertanyaan-pertanyaan yang akan kami berikan setelah ini akan lebih menggali informasi lebih jauh mengenai anda.</h4>
			...
			<div class="box-tanya-jawab-5 hide">
				...
				<div class="box box-english3">
					<div class="box-body">
						<h3>3. Where do you usually see the Sampoerna A Mild campaign advertisement ?</h3>
						<small><i>(Di media apa biasanya Anda melihat iklan tentang promosi Sampoerna A Mild ?)</i></small>
						<div class="radio">
							<label>
				...
				<div class="box box-closing-d">
					<div class="box-body">
						...
						<h4>Mohon pertanyaan kami berikut ini di konfirmasi :</h4>
					</div>				
				</div>
